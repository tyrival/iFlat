 ...
 */
public class QualityFineManagerImpl extends IflatManagerSupport {
    ...
    public void setImportExcelReader() throws Exception {
        ...
        super.getExcelReader().setProps(new String[]{"projNo","dept","team","group","person", "date", "profession", "description", "comment", "qc", "creator", "createTime"});
    }
