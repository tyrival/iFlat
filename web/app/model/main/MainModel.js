Ext.define('iFlat.model.main.MainModel', {
    ...
    data: {
        ...
        ssPhDmgType: ['物体打击','起重伤害','高处坠落','触电','机械伤害','车辆伤害','挤压伤害','滑跌','火灾','淹溺','燃爆','中毒和窒息','坍塌'],
        ...
        ssFiveSFuncDept: ['纪委办公室', '党群工作部', '企业文化部', '工会', '总经理办公室', '企划部', '法律顾问室', '监察审计部', '生产管理部', '人力资源部', '财务部', '研发部', '设计部', '综合技术部', '造船事业部', '造船经营部', '修船经营部', '钢结构经营部', '修船事业部', '质量部', '生产保障部', '安环保卫部', '物资部', '劳务中心', '钢结构事业部', '华尔新特涂公司', '华澄公司','造船加工车间','造船船体车间','造船安装车间','修船冷作车间','修船坞修车间','修船舾装车间','修船机电修理车间','修船机加工车间','钢结构事业部'],
