Ext.define('iFlat.view.report.complex.bi.ProjectInfo', {
    extend: 'Ext.panel.Panel',

    controller: 'rpt-complex-bi-projectinfo',

    requires: [
        'iFlat.view.report.complex.bi.ProjectInfoController'
    ],
    ...
    items: [{
        xtype: 'datefield',
        id: 'rpt-complex-bi-projectinfo-period',
        hidden: true,
        listeners: {
            change: 'reload'
        }
        ...
        xtype: 'grid',
        id: 'rpt-complex-bi-projectinfoproj-grid1',
        margin: '10 0 0 0',
        border: true,
        columnLines: true,
        flex: 1,
        store: rptComplexBiProjectInfoStore = Ext.create('iFlat.store.bi.ProjectInfo'),
        columns: [{
            text: '船名',
            flex: true,
        ...
        xtype: 'grid',
        id: 'rpt-complex-bi-projectinfoproj-grid2',
        margin: '10 0 0 0',
        border: true,
        columnLines: true,
        flex: 1,
        ...
        xtype: 'grid',
        id: 'rpt-complex-bi-projectinfoproj-grid3',
        margin: '10 0 0 0',
        border: true,
        columnLines: true,
        flex: 1,
