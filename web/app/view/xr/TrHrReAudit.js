Ext.define('iFlat.view.xr.TrHrReAudit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-trhrreaudit',
    ...
    requires: [
        ...
        'iFlat.view.xr.TrHrReAuditController',
    ],

    controller: 'xr-trhrreaudit',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    store: trHrReAuditDetailStore = Ext.create('iFlat.store.xr.TrSettlementDetl'),
                    border: true,
                    columnLines: true,
