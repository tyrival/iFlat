Ext.define('iFlat.view.xr.SrWorkshopDirectorApproveController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-srworkshopdirectorapprove',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srWorkshopDirectorApproveDetailStore.getProxy().extraParams['srSettlementDetl.pid'] = id;
                        srWorkshopDirectorApproveDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-srworkshopdirectorapprove');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-srworkshopdirectorapprove-down');
