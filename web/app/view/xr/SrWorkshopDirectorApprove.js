Ext.define('iFlat.view.xr.SrWorkshopDirectorApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srworkshopdirectorapprove',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrWorkshopDirectorApproveController',
    ],

    controller: 'xr-srworkshopdirectorapprove',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    margin: '0 0 0 100',
                    hidden: true,
                    id: 'xr-srworkshopdirectorapprove-down',
                    width: 100,
                }]
            }, {
                xtype: 'panel',
                ...
                items: [{
                    ...
                    store: srWorkshopDirectorApproveDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
