Ext.define('iFlat.view.xr.TrQuotaEstimateController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-trquotaestimate',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        trQuotaEstimateDetailStore.getProxy().extraParams['trSettlementDetl.pid'] = id;
                        trQuotaEstimateDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-trquotaestimate');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-trquotaestimate-down');
