Ext.define('iFlat.view.xr.SrHrReAudit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srhrreaudit',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrHrReAuditController',
    ],

    controller: 'xr-srhrreaudit',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    store: srHrReAuditDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
