Ext.define('iFlat.view.xr.SrSafetyAssessController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-srsafetyassess',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srSafetyAssessDetailStore.getProxy().extraParams['srSettlementDetl.pid'] = id;
                        srSafetyAssessDetailStore.reload();
                        
                        assess.getProxy().extraParams['srAssess.settId'] = id;
                        assess.getProxy().extraParams['srAssess.type'] = '安保部';
                        assess.reload({
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-srsafetyassess');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-srsafetyassess-down');
