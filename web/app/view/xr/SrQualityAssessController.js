Ext.define('iFlat.view.xr.SrQualityAssessController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-srqualityassess',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srQualityAssessDetailStore.getProxy().extraParams['srSettlementDetl.pid'] = id;
                        srQualityAssessDetailStore.reload();
                        
                        assess.getProxy().extraParams['srAssess.settId'] = id;
                        assess.getProxy().extraParams['srAssess.type'] = '技术质量部';
                        assess.reload({
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-srqualityassess');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-srqualityassess-down');
