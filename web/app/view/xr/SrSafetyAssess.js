Ext.define('iFlat.view.xr.SrSafetyAssess', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srsafetyassess',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrSafetyAssessController',
    ],

    controller: 'xr-srsafetyassess',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    fieldLabel: '外包工',
                    id: 'xr-srsafetyassess-isoutwork',
                ...
                items: [{
                    ...
                    store: srSafetyAssessDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
