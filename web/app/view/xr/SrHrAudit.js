Ext.define('iFlat.view.xr.SrHrAudit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srhraudit',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrHrAuditController',
    ],

    controller: 'xr-srhraudit',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    store: srHrAuditDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
