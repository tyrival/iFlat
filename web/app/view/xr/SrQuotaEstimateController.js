Ext.define('iFlat.view.xr.SrQuotaEstimateController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-srquotaestimate',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srQuotaEstimateDetailStore.getProxy().extraParams['srSettlementDetl.pid'] = id;
                        srQuotaEstimateDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-srquotaestimate');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-srquotaestimate-down');
