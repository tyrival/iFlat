Ext.define('iFlat.view.xr.TrApplyDeptDirectorApproveController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-trapplydeptdirectorapprove',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        trApplyDeptDirectorApproveDetailStore.getProxy().extraParams['trSettlementDetl.pid'] = id;
                        trApplyDeptDirectorApproveDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-trapplydeptdirectorapprove');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-trapplydeptdirectorapprove-down');
