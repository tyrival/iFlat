Ext.define('iFlat.view.xr.SrQualityAssess', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srqualityassess',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrQualityAssessController',
    ],

    controller: 'xr-srqualityassess',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    fieldLabel: '外包工',
                    id: 'xr-srqualityassess-isoutwork',
                ...
                items: [{
                    ...
                    store: srQualityAssessDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
