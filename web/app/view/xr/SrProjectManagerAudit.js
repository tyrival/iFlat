Ext.define('iFlat.view.xr.SrProjectManagerAudit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-srprojectmanageraudit',
    ...
    requires: [
        ...
        'iFlat.view.xr.SrProjectManagerAuditController',
    ],

    controller: 'xr-srprojectmanageraudit',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    fieldLabel: '外包工',
                    id: 'xr-srprojectmanageraudit-isoutwork',
                ...
                items: [{
                    ...
                    margin: '0 0 0 100',
                    hidden: true,
                    id: 'xr-srprojectmanageraudit-down',
                    width: 100,
                }]
            }, {
                xtype: 'panel',
                ...
                items: [{
                    ...
                    store: srProjectManagerAuditDetailStore = Ext.create('iFlat.store.xr.SrSettlementDetl'),
                    border: true,
                    columnLines: true,
                    plugins: [
                        Ext.create('Ext.grid.plugin.RowEditing', {
                            ...
                            listeners: {
                                ...
                                beforeedit: function(editor , context , eOpts){
                                    // 如果施工内容已定额，禁止修改
                                    if (context.record.get('srSettlementDetl.isQuota')) {
                                        return false;
                                    }
                                },
                            }
                    ...
                    columns: [{
                        ...
                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                            if (value == record.get('srSettlementDetl.applyContent')) {
                                return '';
                            } else {
                                return value;
                            }
                        ...
                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                            if (value == record.get('srSettlementDetl.applyQty')) {
                                return '';
                            } else {
                                return value;
                            }
