Ext.define('iFlat.view.xr.TrApplyDeptDirectorApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-trapplydeptdirectorapprove',
    ...
    requires: [
        ...
        'iFlat.view.xr.TrApplyDeptDirectorApproveController',
    ],

    controller: 'xr-trapplydeptdirectorapprove',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    margin: '0 0 0 100',
                    hidden: true,
                    id: 'xr-trapplydeptdirectorapprove-down',
                    width: 100,
                }]
            }, {
                xtype: 'panel',
                ...
                items: [{
                    ...
                    store: trApplyDeptDirectorApproveDetailStore = Ext.create('iFlat.store.xr.TrSettlementDetl'),
                    border: true,
                    columnLines: true,
