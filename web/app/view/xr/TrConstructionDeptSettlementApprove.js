Ext.define('iFlat.view.xr.TrConstructionDeptSettlementApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.xr-trconstructiondeptsettlementapprove',
    ...
    requires: [
        ...
        'iFlat.view.xr.TrConstructionDeptSettlementApproveController',
    ],

    controller: 'xr-trconstructiondeptsettlementapprove',
    closeAction: 'hide',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    fieldLabel: '二级明细汇总',
                    labelWidth: 100,
                    id: 'xr-trconstructiondeptsettlementapprove-sum',
                    width: '24%',
                    editable: false,
                }]
            }, {
                ...
                items: [{
                    ...
                    margin: '0 0 0 56',
                    hidden: true,
                    id: 'xr-trconstructiondeptsettlementapprove-down',
                    width: 100,
                }, {
                    xtype: 'textfield',
                    ...
                    margin: '0 0 0 56',
                    hidden: true,
                    id: 'xr-trconstructiondeptsettlementapprove-down2',
                    width: 140,
                }]
            }, {
                xtype: 'panel',
                ...
                items: [{
                    ...
                    store: trConstructionDeptSettlementApproveDetailStore = Ext.create('iFlat.store.xr.TrSettlementDetl'),
                    border: true,
                    columnLines: true,
