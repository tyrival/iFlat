Ext.define('iFlat.view.xr.SrBusinessDivisionDirectorApproveController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.xr-srbusinessdivisiondirectorapprove',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srBusinessDivisionDirectorApproveDetailStore.getProxy().extraParams['srSettlementDetl.pid'] = id;
                        srBusinessDivisionDirectorApproveDetailStore.reload();
                        
                        assess.getProxy().extraParams['srAssess.settId'] = id;
                        assess.getProxy().extraParams['srAssess.type'] = '生产部';
                        assess.reload({
    ...
    completeTask: function (btn) {
        var panel = btn.up('xr-srbusinessdivisiondirectorapprove');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('xr-srbusinessdivisiondirectorapprove-down');
