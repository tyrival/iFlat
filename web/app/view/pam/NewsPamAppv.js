Ext.define('iFlat.view.pam.NewsPamAppv', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pam-newspamappv',
    xtype: 'pam-newspamappv',

    controller: 'pam-newsappv',
    store: pamNewsPamAppvStore = Ext.create('iFlat.store.pam.News', {
        proxy: {
            extraParams: {
                'news.status': '待党群审核'
            }
