Ext.define('iFlat.view.wip.SrOsBusinessDivisionDirectorApproveController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.wip-srosbusinessdivisiondirectorapprove',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        srOsBusinessDivisionDirectorApproveDetailStore.getProxy().extraParams['srOutsourceDetl.pid'] = id;
                        srOsBusinessDivisionDirectorApproveDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('wip-srosbusinessdivisiondirectorapprove');
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosbusinessdivisiondirectorapprove-down');
    ...
    onAttachmentChange2: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosbusinessdivisiondirectorapprove-down2');
        btnDown.setHref(newValue);
        if (!Flat.util.isEmpty(newValue)) {
            btnDown.show();
        } else {
    ...
    onAttachmentChange3: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosbusinessdivisiondirectorapprove-down3');
        btnDown.setHref(newValue);
        if (!Flat.util.isEmpty(newValue)) {
            btnDown.show();
        } else {
    ...
    showBidding: function () {
        var id = Ext.getCmp('wip-srosbusinessdivisiondirectorapprove-id').getValue();
