Ext.define('iFlat.view.wip.SrOsProfessionalManagerConfirmController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.wip-srosprofessionalmanagerconfirm',
            ...
            callback: function(records, option, success) {
                ...
                if (!success) {
                    ...
                    if (records != null && records.length > 0) {
                        ...
                        var id = record.get('srOutsource.id');
                        srOsProfessionalManagerConfirmDetailStore.getProxy().extraParams['srOutsourceDetl.pid'] = id;
                        srOsProfessionalManagerConfirmDetailStore.reload();
                    }
                }
            }
        })
    ...
    completeTask: function (btn) {
        var panel = btn.up('wip-srosprofessionalmanagerconfirm');
    ...
    showBidding: function () {
        var id = Ext.getCmp('wip-srosprofessionalmanagerconfirm-id').getValue();
    ...
    onAttachmentChange: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosprofessionalmanagerconfirm-down');
    ...
    onAttachmentChange2: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosprofessionalmanagerconfirm-down2');
        btnDown.setHref(newValue);
        if (!Flat.util.isEmpty(newValue)) {
            btnDown.show();
        } else {
    ...
    onAttachmentChange3: function(field, newValue, oldValue, eOpts) {
        var btnDown = Ext.getCmp('wip-srosprofessionalmanagerconfirm-down3');
        btnDown.setHref(newValue);
        if (!Flat.util.isEmpty(newValue)) {
            btnDown.show();
        } else {
