Ext.define('iFlat.view.wip.SrOsContractHandle', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-sroscontracthandle',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-sroscontracthandle-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-sroscontracthandle-detail',
                        store: srOsContractHandleDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [/*{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-sroscontracthandle-down2',
                    }]
                }, ]
            }, {
                xtype: 'fieldset',
                ...
                xtype: 'container',
                layout: 'hbox',
                id: 'wip-sroscontracthandle-att3',
                margin: '10 0 0 75',
                hidden: true,
                items: [{
                    xtype: 'textfield',
                    id: 'wip-sroscontracthandle-attachment3',
                    ...
                    xtype: 'button',
                    id: 'wip-sroscontracthandle-link3',
                    text: '下载资料附件',
                    margin: '0 5 0 0',
                    width: 100,
                }, {
                    xtype: 'button',
                    id: 'wip-sroscontracthandle-deleteatt3',
                    ui: 'gray',
                    text: '删除',
                    handler: 'deleteAttachment3'
                }]
            }, {
                xtype: 'container',
                layout: 'hbox',
                margin: '10 0 0 0',
                id: 'wip-sroscontracthandle-uploadatt3',
                items: [{
                    xtype: 'form',
                    id: 'wip-sroscontracthandle-upload3',
                    fieldDefaults: {
                        labelAlign: 'right',
                        labelWidth: 50,
                    },
