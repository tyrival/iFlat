Ext.define('iFlat.view.wip.SrOsBusinessDivisionDirectorApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosbusinessdivisiondirectorapprove',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsBusinessDivisionDirectorApproveController',
    ],

    controller: 'wip-srosbusinessdivisiondirectorapprove',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        fieldLabel: 'ID',
                        name: 'srOutsource.id',
                        id: 'wip-srosbusinessdivisiondirectorapprove-id',
                        hidden: true,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srosbusinessdivisiondirectorapprove-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosbusinessdivisiondirectorapprove-detail',
                        store: srOsBusinessDivisionDirectorApproveDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srosbusinessdivisiondirectorapprove-down2',
                    }]
                }, ]
            }, {
                xtype: 'fieldset',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srosbusinessdivisiondirectorapprove-down3',
                    }, ]
