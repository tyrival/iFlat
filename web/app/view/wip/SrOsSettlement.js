Ext.define('iFlat.view.wip.SrOsSettlement', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srossettlement',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsSettlementController',
    ],

    controller: 'wip-srossettlement',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srossettlement-detail',
                        store: srOsSettlementDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    id: 'wip-srossettlement-attachment5',
                ...
                xtype: 'container',
                layout: 'hbox',
                id: 'wip-srossettlement-att5',
                margin: '10 0 0 75',
                hidden: true,
                items: [{
                    xtype: 'button',
                    id: 'wip-srossettlement-link5',
                    text: '下载结算附件',
                    margin: '0 5 0 0',
                    width: 100,
                }, {
                    xtype: 'button',
                    id: 'wip-srossettlement-deleteatt5',
                    ui: 'gray',
                    text: '删除',
                    handler: 'deleteAttachment5'
                }]
            }, {
                xtype: 'container',
                layout: 'hbox',
                margin: '10 0 0 0',
                id: 'wip-srossettlement-uploadatt5',
                items: [{
                    xtype: 'form',
                    id: 'wip-srossettlement-upload5',
                    fieldDefaults: {
                        labelAlign: 'right',
                        labelWidth: 50,
                    },
