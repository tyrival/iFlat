Ext.define('iFlat.view.wip.SrOsInspectChiefHandle', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosinspectchiefhandle',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsInspectChiefHandleController',
    ],

    controller: 'wip-srosinspectchiefhandle',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        fieldLabel: 'ID',
                        name: 'srOutsource.id',
                        id: 'wip-srosinspectchiefhandle-id',
                        hidden: true,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srosinspectchiefhandle-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosinspectchiefhandle-detail',
                        store: srOsInspectChiefHandleDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srosinspectchiefhandle-down3',
                    }, ]
