Ext.define('iFlat.view.wip.SrOsSalesmanReaudit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srossalesmanreaudit',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsSalesmanReauditController',
    ],

    controller: 'wip-srossalesmanreaudit',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srossalesmanreaudit-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srossalesmanreaudit-detail',
                        store: srOsSalesmanReauditDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossalesmanreaudit-down2',
                        width: 100,
                    }, */]
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srossalesmanreaudit-down3',
                    }, ]
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossalesmanreaudit-down4',
                        width: 100,
                    }]
                }]
            }, {
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossalesmanreaudit-down5',
                        width: 100,
                    }]
                }, {
                    xtype: 'container',
