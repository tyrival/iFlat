Ext.define('iFlat.view.wip.SrOsProfessionalManagerAssess', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosprofessionalmanagerassess',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsProfessionalManagerAssessController',
    ],

    controller: 'wip-srosprofessionalmanagerassess',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        fieldLabel: 'ID',
                        name: 'srOutsource.id',
                        id: 'wip-srosprofessionalmanagerassess-id',
                        hidden: true,
                        listeners: {
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerassess-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosprofessionalmanagerassess-detail',
                        store: srOsProfessionalManagerAssessDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerassess-down3',
                    }, ]
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerassess-down4',
                        width: 100,
                    }]
                }]
            }, {
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerassess-down5',
                        width: 100,
                    }]
                }, {
                    xtype: 'container',
