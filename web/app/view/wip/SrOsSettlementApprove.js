Ext.define('iFlat.view.wip.SrOsSettlementApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srossettlementapprove',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsSettlementApproveController',
    ],

    controller: 'wip-srossettlementapprove',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        fieldLabel: 'ID',
                        name: 'srOutsource.id',
                        id: 'wip-srossettlementapprove-id',
                        hidden: true,
                        listeners: {
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srossettlementapprove-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srossettlementapprove-detail',
                        store: srOsSettlementApproveDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossettlementapprove-down2',
                    }]
                }, ]
            }, {
                xtype: 'fieldset',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srossettlementapprove-down3',
                    }, ]
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossettlementapprove-down4',
                        width: 100,
                    }]
                }]
            }, {
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srossettlementapprove-down5',
                        width: 100,
                    }]
                }, {
                    xtype: 'container',
