Ext.define('iFlat.view.wip.SrOsInspect', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosinspect',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsInspectController',
    ],

    controller: 'wip-srosinspect',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosinspect-detail',
                        store: srOsInspectDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    xtype: 'textfield',
                    id: 'wip-srosinspect-attachment4',
                ...
                xtype: 'container',
                layout: 'hbox',
                id: 'wip-srosinspect-att4',
                margin: '10 0 0 75',
                hidden: true,
                items: [{
                    xtype: 'button',
                    id: 'wip-srosinspect-link4',
                    text: '下载检验附件',
                    margin: '0 5 0 0',
                    width: 100,
                }, {
                    xtype: 'button',
                    id: 'wip-srosinspect-deleteatt4',
                    ui: 'gray',
                    text: '删除',
                    handler: 'deleteAttachment4'
                }]
            }, {
                xtype: 'container',
                layout: 'hbox',
                margin: '10 0 0 0',
                id: 'wip-srosinspect-uploadatt4',
                items: [{
                    xtype: 'form',
                    id: 'wip-srosinspect-upload4',
                    fieldDefaults: {
                        labelAlign: 'right',
                        labelWidth: 50,
                    },
