Ext.define('iFlat.view.wip.SrOsProjectManagerApprove', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosprojectmanagerapprove',
    ...
    requires: [
        ...
        'iFlat.view.wip.SrOsProjectManagerApproveController',
    ],

    controller: 'wip-srosprojectmanagerapprove',
    closeAction: 'hide',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srosprojectmanagerapprove-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        store: srOsProjectManagerApproveDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
