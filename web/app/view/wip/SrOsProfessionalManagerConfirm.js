Ext.define('iFlat.view.wip.SrOsProfessionalManagerConfirm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosprofessionalmanagerconfirm',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        fieldLabel: 'ID',
                        name: 'srOutsource.id',
                        id: 'wip-srosprofessionalmanagerconfirm-id',
                        hidden: true,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 75',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerconfirm-down',
                        width: 100,
                    }, {
                        xtype: 'textfield',
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosprofessionalmanagerconfirm-detail',
                        store: srOsProfessionalManagerConfirmDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 20',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerconfirm-down2',
                    }]
                }, ]
            }, {
                xtype: 'fieldset',
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        margin: '0 0 0 10',
                        hidden: true,
                        id: 'wip-srosprofessionalmanagerconfirm-down3',
                    }, ]
