Ext.define('iFlat.view.wip.SrOsManufacture', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wip-srosmanufacture',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        width: '100%',
                        scrollable: true,
                        id: 'wip-srosmanufacture-detail',
                        store: srOsManufactureDetailStore = Ext.create('iFlat.store.wip.SrOutsourceDetl'),
                        border: true,
                        columnLines: true,
                        columns: [{
                            header: '施工内容',
