Ext.define('iFlat.view.sm.temp.detail.SrApproveMisc', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sm-detail-srapprovemisc',
    ...
    border: true,
    columnLines: true,
    store: smSrApproveMiscDetailStore = Ext.create('iFlat.store.sm.SrSettlementDetlFirst'),
