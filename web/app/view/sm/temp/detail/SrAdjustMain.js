Ext.define('iFlat.view.sm.temp.detail.SrAdjustMain', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sm-detail-sradjustmain',
    ...
    border: true,
    columnLines: true,
    store: smSrAdjustMainDetailStore = Ext.create('iFlat.store.sm.SrSettlementDetlFirst'),
    ...
    plugins: [
        smSrAdjustMainDetailRowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
            pluginId: 'sm-sradjustmainedit-detail-edit',
